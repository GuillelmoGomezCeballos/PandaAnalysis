...
d = {
    ...
    'DYJetsToLL_POWHEG'             : ['ZToMuMu_NNPDF30_13TeV-powheg_M_50_120','ZToEE_NNPDF30_13TeV-powheg_M_50_120'],
    'DYJetsToMM_POWHEG'             : ['ZToMuMu_NNPDF30_13TeV-powheg_M_50_120'],
    'DYJetsToEE_POWHEG'             : ['ZToEE_NNPDF30_13TeV-powheg_M_50_120'],
    'DYJetsToEE_POWHEG_MINLO'       : ['ZJToEEJ_M-50_scalesUpTo8_NNPDF31_plus_CMSPDF_TuneCP5_13TeV_powheg2-minlo-pythia'],
    'ZtoNuNu_pt100to250'	    : ['ZtoNuNu_pt100to250'],
    'ZtoNuNu_pt250to400'	    : ['ZtoNuNu_pt250to400'],
    'ZtoNuNu_pt400to650'	    : ['ZtoNuNu_pt400to650'],
    'ZtoNuNu_pt650toinf'	    : ['ZtoNuNu_pt650toinf'],
    ...
    'WZ3l_0Jets_MG_QCD'             : ['WZTo3LNu_0Jets_MLL-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8'],
    'WZ3l_1Jets_MG_QCD'             : ['WZTo3LNu_1Jets_MLL-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8'],
    'WZ3l_2Jets_MG_QCD'             : ['WZTo3LNu_2Jets_MLL-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8'],
    'WZ3l_3Jets_MG_QCD'             : ['WZTo3LNu_3Jets_MLL-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8'],
    'WWjj_SS_long_new'              : ['WWjj_SS_long_new_Summer16'],
    'WWjj_SS_lt_new'                : ['WWjj_SS_lt_new_Summer16'],
    'WWjj_SS_tt_new'                : ['WWjj_SS_tt_new_Summer16'],
    'WWjj_SS_long_wwframe'          : ['WWjj_SS_long_wwframe_Summer16'],
    'WWjj_SS_lt_wwframe'            : ['WWjj_SS_lt_wwframe_Summer16'],
    'WWjj_SS_tt_wwframe'            : ['WWjj_SS_tt_wwframe_Summer16'],
    'WWjj_SS_lttt'                  : ['WWjj_SS_lttt_Summer16'],
    'WWjj_SS_long'                  : ['WWjj_SS_long_Summer16'],
    'WWjj_SS_interference'          : ['WWjj_SS_interference_Summer16'],
    'WZJJ_interference'             : ['WZJJ_interference_Summer16'],
    'MET'                           : ['MET'],
